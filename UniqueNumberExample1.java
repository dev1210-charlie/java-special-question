//By Comparing Each Digit Manually.There are the following steps to check number is unique or not:
//Read a number from the user.Find the last digit o the number.Compare all digits of the number with the last digit.
//If the digit found more than one time, the number is not unique.Else, eliminate the last digit of the number.
